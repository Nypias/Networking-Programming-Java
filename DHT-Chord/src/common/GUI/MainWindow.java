...
public class MainWindow extends javax.swing.JFrame implements Runnable {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (fileApp.mapCode(hash)!=null){userText.append(">You already have this File!\n");return;}
    ...
    */
    ...
    public void run(){
        ...
        {
            try {
            if(this.chord!=null){chord.printVars();
            this.chord.printFingers();

            }
            if(this.mapper!=null){mapper.printInfo(); mapper.printMap();} else this.getKeysInfoText().setText("==no Mapper connected===");
